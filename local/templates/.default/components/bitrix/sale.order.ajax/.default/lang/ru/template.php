...
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\" class=\"text-success\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
...
$MESS["SOA_ERROR_ORDER_LOST1"] = "Возможно, заказ привязан к другой учетной записи. В этом случае Вам необходимо авторизоваться на сайте под нужной учетной записью";
$MESS["SOA_ERROR_ORDER_LOST2"] = "Пожалуйста обратитесь к администрации интернет-магазина или попробуйте оформить ваш заказ еще раз.";
...
$MESS["PAY_SYSTEM_PAYABLE_ERROR_DEFAULT"] = "Вы сможете оплатить заказ после того, как менеджер проверит наличие полного комплекта товаров на складе. Сразу после проверки вы получите письмо с инструкциями по оплате.";
$MESS['SOA_ORDER_PAYED'] = 'Заказ оплачен';
