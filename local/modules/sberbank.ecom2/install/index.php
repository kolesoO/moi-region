...
Class sberbank_ecom2 extends CModule {
    ...
    function __construct() {
        ...
        $this->PAYMENT_HANDLER_PATH = $_SERVER["DOCUMENT_ROOT"] . "/local/php_interface/include/sale_payment/" . str_replace(".", "_", $this->MODULE_ID) . "/";
    }
    ...
    function UnInstallFiles() {
        DeleteDirFilesEx("/local/php_interface/include/sale_payment/" . str_replace(".", "_", $this->MODULE_ID));
    }
